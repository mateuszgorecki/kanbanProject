...
<body>
  ...
  <div class="main-wrapper col-12">
    ...
    <div class="menu-wrapper col-12 wrapper-style">
      ...
      <a class="button-content button-style" href="user_tasks_admin.php"><button type="button">Tasks</button></a>
      ...
      <div class="users-list__wrapper col-2">
        <div class="user-list__inner-wrapper wrapper-style">
          ...
          <div class="user-list">
			...
			echo "<div class='collumn button-style' value='".$kolumna['login']."'>".$kolumna['login']."</div>";
			}
			mysqli_close($con);
		?>
          </div>
